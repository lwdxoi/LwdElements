class LwdButton extends LwdElement{constructor(a={}){super(void 0,a),this.shadowRoot.append(new LwdSlot),this.type||="primary"}static get observedAttributes(){return[...super.observedAttributes,"value","type","name"]}get styleSheet(){return`${super.styleSheet}
:host{
  display: inline-flex;
